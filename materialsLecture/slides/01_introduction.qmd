...
::: {.column width="50%"}
```{r genai2, echo=FALSE, out.width = "100%", fig.align='center',  purl=FALSE}
...
## Still learning programming in 2026: why?

- AI has made **learning to code more enjoyable**: flatter learning curve for beginners -> higher returns on effort investment at the beginning -> not stuck -> fun!
- **AI ≠ mastery**. Everyone can code with AI. \ But: A data scientist is someone who has developed skills, flair for data, creativity, and solid fundamentals. This has become the talent employers seek after.
- develop a **mindset for data analysis and problem solving**: solution-oriented and pragmatism, communication and story-telling, algorithmic thinking, debugging and patience with mistakes, attention to detail, etc.
- learn the language you need to **prompt LLMs efficiently**.
...
#### Weekly plenary sessions
  ...
  - As interactive as possible, with questions encouraged.
...
### In-class exercise sessions (bi-weekly evening sessions)
  ...
  - *First Exercises (set up R/RStudio) is available on Canvas today*
...
- R vs Python: not a war. Python is stronger for general programming and machine learning, R for statistics and data analysis. The concepts in this course transfer, and many teams use both.
...
[👈](https://aureliensallin.ch/BEcon_3230_Datahandling_ImportCleaningandVisualization/)
:::
