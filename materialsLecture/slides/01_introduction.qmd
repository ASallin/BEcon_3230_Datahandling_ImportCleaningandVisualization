...
format:
  revealjs:
    ...
    # shown at the bottom of every slide, and in scroll view
    footer: "[← Course page](https://aureliensallin.ch/BEcon_3230_Datahandling_ImportCleaningandVisualization/)"
...
- I believe in **active participation** and **hands-on learning**.
- I
...
#### Goal
Demonstrate your understanding of the concepts and practical applications covered in the course. Beyond the critical use of LLMs, students must demonstrate their own grasp of the group project and ensure fair collaboration in group work, avoiding free-riding.
...
## A note on AI and the learning process
...
[:point_left: Back to the course page](https://aureliensallin.ch/BEcon_3230_Datahandling_ImportCleaningandVisualization/)
:::
